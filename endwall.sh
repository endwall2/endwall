...
########################### GOPHER ############################################################################
iptables -A INPUT  -i lo  -p tcp -m multiport --dports 70  -j PASS
iptables -A INPUT  -i lo  -p tcp -m multiport --sports 70  -j PASS
iptables -A OUTPUT -o lo  -p tcp -m multiport --dports 70 -j PASS
iptables -A OUTPUT -o lo  -p tcp -m multiport --sports 70 -j PASS

ip6tables -A INPUT  -i lo  -p tcp -m multiport --dports 70  -j PASS
ip6tables -A INPUT  -i lo  -p tcp -m multiport --sports 70  -j PASS
ip6tables -A OUTPUT -o lo  -p tcp -m multiport --dports 70  -j PASS
ip6tables -A OUTPUT -o lo  -p tcp -m multiport --sports 70  -j PASS

iptables -A INPUT  -i lo  -p udp -m multiport --dports 70  -j PASS
iptables -A INPUT  -i lo  -p udp -m multiport --sports 70  -j PASS
iptables -A OUTPUT -o lo  -p udp -m multiport --dports 70 -j PASS
iptables -A OUTPUT -o lo  -p udp -m multiport --sports 70 -j PASS

ip6tables -A INPUT  -i lo  -p udp -m multiport --dports 70  -j PASS
ip6tables -A INPUT  -i lo  -p udp -m multiport --sports 70  -j PASS
ip6tables -A OUTPUT -o lo  -p udp -m multiport --dports 70  -j PASS
ip6tables -A OUTPUT -o lo  -p udp -m multiport --sports 70  -j PASS
...
####################################  TOR #############################################################
iptables -A INPUT  -i lo  -p tcp -m multiport --dports 9040,9050,9051,9053,9150,9151,9001 -j PASS
iptables -A INPUT  -i lo  -p tcp -m multiport --sports 9040,9050,9051,9053,9150,9151,9001 -j PASS
iptables -A OUTPUT -o lo  -p tcp -m multiport --dports 9040,9050,9051,9053,9150,9151,9001 -j PASS
iptables -A OUTPUT -o lo  -p tcp -m multiport --sports 9040,9050,9051,9053,9150,9151,9001 -j PASS

iptables -A INPUT  -i lo  -p udp -m multiport --dports 9053 -j PASS
iptables -A INPUT  -i lo  -p udp -m multiport --sports 9053 -j PASS
iptables -A OUTPUT -o lo  -p udp -m multiport --dports 9053 -j PASS
iptables -A OUTPUT -o lo  -p udp -m multiport --sports 9053 -j PASS
...
##################################################      GOPHER CLIENT  #######################################################################
iptables -A OUTPUT -o $int_if -s "$int_ip1" -p tcp -m multiport --dports 70 -m state --state NEW,ESTABLISHED -j PASS
iptables -A INPUT  -i $int_if -d "$int_ip1" -p tcp -m multiport --sports 70 -m state --state ESTABLISHED -j PASS
iptables -A OUTPUT -o $int_if -s "$int_ip1" -p udp -m multiport --dports 70 -m state --state NEW,ESTABLISHED -j PASS
iptables -A INPUT  -i $int_if -d "$int_ip1" -p udp -m multiport --sports 70 -m state --state ESTABLISHED -j PASS
