...
#################     DROP BROADCAST   ###############################################
iptables -A INPUT  -i $int_if -s 255.255.255.255 -j DROP
iptables -A INPUT  -i $int_if -s 192.168.255.255 -j DROP
iptables -A INPUT  -i $int_if -s 192.168.0.255   -j DROP
iptables -A INPUT  -i $int_if -s 153.122.255.255 -j DROP
iptables -A INPUT  -i $int_if -s 153.122.1.255   -j DROP
iptables -A INPUT  -i $int_if -s 172.2.255.255 -j DROP
iptables -A INPUT  -i $int_if -s 172.2.1.255   -j DROP
iptables -A INPUT  -i $int_if -s 10.0.0.0/8      -j DROP
