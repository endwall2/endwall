...
###################################################################################################
version="1.46"
branch="gnu/linux,nft,wifi,roaming"
rev_date="16/08/2022"
state="closed"
...
#wlan_if="$int_if2"
wlan_if="$(ip link | grep -a "state " | grep "w" | cut -d \:  -f 2)"
...
client_out_roam udp 67,68

#############################################    DNS   Client           ##############################################################################

client_out_roam udp 53,953
client_out_roam tcp 53,953
...
##########################################       HTTP/HTTPS PROXY       ##############################################################################
client_out_roam tcp 8000,8080,8081,8443,8445,8090,9090,3128,8123
##########################################   SQUID HTTPS PROXY          ##############################################################################
client_out_roam tcp 3128
##########################################        SOCK4,SOCK5 Client    ##############################################################################
client_out_roam tcp 1080,1085
##########################################         IRC Client           ##############################################################################
client_out_roam tcp 6667,6668,6669,6697,9999
##########################################        XMPP Client           ##############################################################################
client_out_roam tcp 5190,5222,5223,5269,5280,5281,5298,8010
client_out_roam udp 5298,5222
##########################################       MSN Client             ##############################################################################
#client_out_roam tcp 1863
##########################################         FTP Client           ##############################################################################
client_out_roam tcp 20,21,989,990,2121
client_out_roam udp 20,21,989,990,2121

# 50000-55663
client_out_roam tcp 50000-55663
client_out_roam udp 50000-55663
client_out_roam tcp 60000-60100
client_out_roam udp 60000-60100
##########################################         NNTP Client          ##############################################################################
client_out_roam tcp 119,563
client_out_roam udp 119,563
##########################################        TELNET  Client        ##############################################################################
client_out_roam tcp 23
###########################################        SSH  Client          ##############################################################################
client_out_roam tcp 22
#############################################       SMTP  Client        ##############################################################################
client_out_roam tcp 25,465,587,2525
##########################################         POP3  Client         ##############################################################################
client_out_roam tcp 110,995
##########################################         IMAP  Client         ##############################################################################
client_out_roam tcp 143,993
#############################################       SMTP  Client        ##############################################################################
client_out_roam tcp 25,465,587,2525
##########################################         POP3  Client         ##############################################################################
client_out_roam tcp 110,995
...
##########################################       TOR  Client        ###############################################################
client_out_roam tcp 9001,9050,9053
##########################################      BitTorrent  Client     ############################################################
client_out_roam tcp 2710,6881,6882,6883,6884,6885,6886,6887,6888,6889,6890,6969,7000 
client_out_roam udp 2710,6881,6882,6883,6884,6885,6886,6887,6888,6889,6890,6969,7000 
client_out_roam udp 30301,6969,3000,2710,4444,1337,80 
##########################################       NETBIOS  Client   ################################################################
#client_out_roam tcp 135,137,138,139
#client_out_roam udp 135,137,138,139
##########################################        SMB   Client      ###############################################################
#client_out_roam tcp 445
##########################################        CUPS   Client     ###############################################################
client_out_roam tcp 631
client_out_roam udp 631
##########################################       PULSE AUDIO  Client ##############################################################
#client_out_roam tcp 4713
##########################################       LDAP  Client        ##############################################################
#client_out_roam tcp 389
#client_out_roam udp 389
##########################################       NFS Client          ##############################################################
#client_out_roam tcp 2049
#client_out_roam udp 2049
##########################################       MYSQL Client        ##############################################################
#client_out_roam tcp 25565
#client_out_roam udp 25565
##########################################         FREENET  Client   ##############################################################
#client_out_roam tcp 8888
#client_out_roam udp 12701,29732
##########################################     GNU NET Client        ##############################################################
#client_out_roam tcp 2086
#client_out_roam udp 2086
##########################################        I2P Client         ##############################################################
#client_out_roam tcp  2827,4444,4445,7652,7653,7655,7654,7656,7657,7658,7659,7660,19648 
#client_out_roam udp  7655,19648 
##########################################     OpenSwan IPsec Client ##############################################################
#client_out_roam udp 500,4500
##########################################       OPEN VPN  Client    ##############################################################
client_out_roam tcp 1194
client_out_roam udp 1194
##########################################          SIP              ##############################################################
client_out_roam tcp 5060,5061
client_out_roam udp 5060
############################################# RTMP ##########################################################
client_out_roam tcp 1935
client_out_roam udp 1935
##########################################      BITCOIN Client       ##############################################################
client_out_roam tcp 8332,8333
##########################################      BITMESSAGE Client    ##############################################################
client_out_roam tcp 8444
##########################################      LITECOIN Client      ##############################################################
client_out_roam tcp 9332,9333
##########################################      GOOGLE TALK Client   ##############################################################
client_out_roam tcp 19294
client_out_roam udp 19294
##########################################     SKYPE Client          ##############################################################
client_out_roam tcp 23399
client_out_roam udp 23399
############################################### INTERNAL SSH ######################################################################
client_out_roam tcp 22543

############################################### MUMBLE #############################################################################
client_out_roam tcp 64738
client_out_roam udp 64738
...
then 
############################################     DHCPv6  Client         ##############################################################################
client6_out_roam udp 546,547
client6_out_roam tcp 546,547
################################################ DNSv6 Client  ###################################################
client6_out_roam udp 53,953
client6_out_roam tcp 53,953
############################################## HTTP HTTPS Client #####################################
client6_out_roam tcp 80,443
fi
